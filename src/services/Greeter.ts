...
import { GreeterService, IGreeterServer } from '../proto/helloworld_grpc_pb';
import { HelloRequest, HelloResponse } from '../proto/helloworld_pb';
...
class Greeter implements IGreeterServer {
  ...
  public sayHello(call: ServerUnaryCall<HelloRequest, HelloResponse>, callback: sendUnaryData<HelloResponse>): void {
    logger.info('sayHello', new Date().toLocaleString());
